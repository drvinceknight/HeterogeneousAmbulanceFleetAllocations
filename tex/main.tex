...
from a pickup location. \textcolor{red}{In both Equation~\ref{eqn:beta} and~\ref{eqn:R}, $\leq$ are used rather than $<$; in Equation~\ref{eqn:beta} will be equivalent, as we assume no two ambulance locations are equidistant; while in Equation~\ref{eqn:R}, in the case of a primary and secondary vehicle having equal travel times, then the primary vehicle will have priority.}
...
\textcolor{red}{The variability over the replications is very small, and we have included 90\% conficence intervals around the mean response times to demonstrate this.}
We observe that the
...
\multirow{2}{*}{Mean Response Time (mins)} & 17.69 & 22.29 & 24.05 \\
 & \textcolor{red}{($\pm$ 0.07)} & \textcolor{red}{($\pm$ 0.06)} & \textcolor{red}{($\pm$ 0.03)} \\[1.5mm]
...
allocations, for each demand scenario\textcolor{red}{, along with 90\% confidence intervals over the trials}. It can be seen that, as expected, as
...
allocations} \textcolor{blue}{as measured by the MESLMHPHF objective function,
...
is due to these patients being more} \textcolor{red}{sensitive to small
fluctuations in
...
\textcolor{blue}{Therefore we present two separate models to measure overall
...
\textcolor{blue}{Combinations of models allow for robust conclusions to be drawn
