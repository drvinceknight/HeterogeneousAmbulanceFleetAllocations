...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "resource_level",
        type=int,
        help="Total number of resources (primary vehicle equivalents) in the allocation.",
    )
    parser.add_argument(
        "max_primary",
        type=int,
    ...
    (
        ...
        number_of_primary_vehicles=args.resource_level,
        number_of_secondary_vehicles=0,
